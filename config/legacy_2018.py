...
class Config(cmt_config):
    ...
    def add_features(self):
        features = [
            ...
            Feature("jet_nMuons", "Jet_nMuons", binning=(10, -0.5, 9.5),
                x_title=Label("jet nMuons")),
            Feature("jet_nElectrons", "Jet_nElectrons", binning=(10, -0.5, 9.5),
            ...
            Feature("Jet_puIdDisc", "Jet_puIdDisc", binning=(10, -0.5, 9.5),
            ...
            Feature("muon_mass", "MuonBPark_mass", binning=(30, 0, 150),
            ...
            Feature("muon_ip3d", "MuonBPark_ip3d", binning=(50, 0, 10),
            ...
            Feature("muon_tightId", "MuonBPark_tightId", binning=(2, -0.5, 1.5),
            ...
            Feature("muonSV_chi2", "muonSV_chi2", binning=(50, 0, 3000),
                x_title=Label("muonSV chi2")),
            Feature("muonSV_pAngle", "muonSV_pAngle", binning=(70, 0, 3.5),
                x_title=Label("muonSV pAngle")),
            Feature("muonSV_dlen", "muonSV_dlen", binning=(70, 0, 35),
                x_title=Label("muonSV dlen")),
            Feature("muonSV_dlenSig", "muonSV_dlenSig", binning=(100, 0, 5000),
            ...
            Feature("sv_mass", "SV_mass", binning=(30, 0, 150),
                x_title=Label("SV mass"),
                units="GeV"),
            Feature("sv_x", "SV_x", binning=(50, -10, 10),
                x_title=Label("muonSV x"),),
            Feature("sv_y", "SV_y", binning=(50, -10, 10),
                x_title=Label("muonSV y"),),
            Feature("sv_z", "SV_z", binning=(100, -20, 20),
                x_title=Label("muonSV z"),),
            Feature("sv_dxy", "SV_dxy", binning=(40, 0, 20),
                x_title=Label("SV dxy")),
            Feature("sv_dxySig", "SV_dxySig", binning=(100, 0, 2500),
                x_title=Label("SV dxySig")),
            Feature("sv_dlen", "SV_dlen", binning=(70, 0, 35),
                x_title=Label("SV dlen")),
            Feature("sv_dlenSig", "SV_dlenSig", binning=(100, 0, 5000),
                x_title=Label("SV dlenSig")),
            Feature("sv_chi2", "SV_chi2", binning=(50, 0, 3000),
                x_title=Label("SV chi2")),
            Feature("sv_pAngle", "SV_pAngle", binning=(70, 0, 3.5),
                x_title=Label("SV pAngle")),
             Feature("sv_ndof", "SV_ndof", binning=(40, -5, 15),
                x_title=Label("SV ndof")),
                
            

            Feature("nmuon", "nMuon", binning=(10, -0.5, 9.5),
                x_title=Label("nMuon")),
