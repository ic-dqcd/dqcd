...
class Config(legacy_config):
    ...
    def add_datasets(self):
        ...
        datasets = [
            ...
            #     process=self.processes.get("scenarioA_mpi_4_mA_1p33_ctau_10_old"),
            #     check_empty=False,
            #     prefix="gfe02.grid.hep.ph.ic.ac.uk/pnfs/hep.ph.ic.ac.uk/data/cms",
            #     xs=signal_xs,
            # ),
            ...
            #     process=self.processes.get("scenarioA_mpi_4_mA_1p33_ctau_10_new"),
            #     check_empty=False,
            #     prefix="gfe02.grid.hep.ph.ic.ac.uk/pnfs/hep.ph.ic.ac.uk/data/cms",
            #     xs=signal_xs,
            #     tags=["ext"]
        ...
        datasets = self.add_vp_grid_datasets(datasets)
        datasets = self.add_scenario_grid_datasets(datasets)
        #datasets = self.add_rew_datasets(datasets)
        #datasets = self.add_rew_test_datasets(datasets)

        return datasets

    def add_vp_grid_datasets(self, datasets):
    ...
    def add_scenario_grid_datasets(self, datasets):
        ...
        for key, dataset in d.items():
            ...
            existing_dataset = any(
                [key.startswith(x) for x in [
                    "scenarioA_mpi_1_mA_0p33",              
                    "scenarioA_mpi_4_mA_0p40",              
                    "scenarioA_mpi_2_mA_0p67",              
                    "scenarioA_mpi_4_mA_1p33",              
                    "scenarioB1_mpi_1_mA_0p33",              
                    "scenarioB1_mpi_2_mA_0p67",              
                    "scenarioB1_mpi_4_mA_1p33",     
                ]
            ])
